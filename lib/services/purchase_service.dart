...
/// Monetizare Tetris: EXCLUSIV reclame + cumpărare de diamante (consumabile,
/// pentru puteri/revive în joc). Fără abonament/„fără reclame".
class PurchaseService {
  ...
  Future<void> initialize() async {
    ...
    final ids = <String>{...diamondPacks.map((p) => p.id)};
